...
func TestSM2Jwt(t *testing.T) {
	token, err := GenTokenSM2()
	if err != nil {
		t.Fatal(err)
	}

	//token := "eyJ0eXAiOiJKV1QiLCJhbGciOiJTTTIifQ..GM-uvtdoxe0OJuwlFelsfBevdU4jjugRcI9rMcNWvgwrG4YvzRTCS8NM4aOQTBKq3xxvfhp41BrZedswrTBl1Q"
	if err := verifyTokenSM2(token); err != nil {
		t.Fatal("verify token sm2:", "err:", err)
	}
